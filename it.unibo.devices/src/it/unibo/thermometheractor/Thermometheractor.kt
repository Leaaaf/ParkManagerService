...
package it.unibo.thermometheractor
...
class Thermometheractor ( name: String, scope: CoroutineScope  ) : ActorBasicFsm( name, scope ){
				...
				state("work") { //this:State
					action { //it:State
						...
						stateTimer = TimerActor("timer_work", 
							scope, context!!, "local_tout_thermometheractor_work", POLLING_TIME )
					}
					 transition(edgeName="t06",targetState="work",cond=whenTimeout("local_tout_thermometheractor_work"))   
