		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					action { //it:State
					 ...
					 transition(edgeName="t00",targetState="work",cond=whenDispatch("updatefan"))
					transition(edgeName="t01",targetState="poweron",cond=whenDispatch("fanon"))
					transition(edgeName="t02",targetState="poweroff",cond=whenDispatch("fanoff"))
				}	 
